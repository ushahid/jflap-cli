...
import edu.duke.cs.jflap.gui.regular.CollapseTool;
import edu.duke.cs.jflap.gui.regular.ConvertPane;
import edu.duke.cs.jflap.gui.regular.FSAToREController;
import edu.duke.cs.jflap.gui.regular.RegularStateTool;
import edu.duke.cs.jflap.gui.regular.RegularTransitionTool;
import edu.duke.cs.jflap.gui.regular.StateCollapseTool;
